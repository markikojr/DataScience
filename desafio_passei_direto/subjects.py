'''This program is going to load and process the data in order to get 
features about the follows in the data'''
...
print("------ Check the subjectname count ------")
...
print("------ Check follows per day from november 2017 on ------")
# From november on
...
print("------ Check follows per day for sept, oct, nov, dec 2017 and jan 2018 ------")
