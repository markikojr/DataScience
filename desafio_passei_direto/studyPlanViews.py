'''This program is going to load the data studyPlanViews.json in order to get 
features from access, topic and subject'''
...
print("------ Check the topic count ------")
print(df['Topic'].value_counts())

print("------ Check the subject count ------")
