'''This program is going to load the data questions.json in order to get 
features about questions and login'''
...
print("------ Check questions per day from november 2017 on ------")
# From november on
...
print("------ Check questions per day for sept, oct, nov, dec 2017 and jan 2018 ------")
...
print("------ Check questions for each month from 02/2017 to 06/2018 ------")
#Questions for each month from 02/2017 to 06/2018
year_list = [2017, 2018]
...
print("------ Check questions for each month from 02/2017 to 06/2018 sum ------")
print(sum(my_list3))
