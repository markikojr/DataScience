...
#NEED THIS TO SEE ERROR WHEN RUNNING ON HEROKU, DEBU = TRUE INS'T ENOUGH
app.logger.addHandler(logging.StreamHandler(sys.stdout))
app.logger.setLevel(logging.ERROR)

#PATH TO LOAD THE LIST
#directory = "/home/markjr/Documents/Data_science/my-project/" #Path just to run locally
directory = "" #No path to run on heroku
